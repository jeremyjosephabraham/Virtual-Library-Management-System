 ...
 * @author UDIT KUMAR
 */
public class P_Add_Books extends javax.swing.JFrame {

    /**
     * Creates new form P_Add_Books
     */
    public P_Add_Books() {
        initComponents();
    ...
    public P_Add_Books(String abc, String dbc) {
        initComponents();
        jLabel8.setText(abc);
        jLabel10.setText(dbc);
        this.setLocationRelativeTo(null);
    }
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Your Publisher ID");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String sql1;
            sql1 = "Insert into books values('"+jTextField1.getText()+"','"+jTextField2.getText()+"','"+jLabel10.getText()+"','"+jTextField7.getText()+"','"+jTextField4.getText()+"','"+jTextField5.getText()+"');";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(P_Add_Books.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new P_Add_Books().setVisible(true);
            }
        });
    }

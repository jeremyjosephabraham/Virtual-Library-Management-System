...
CREATE TABLE `publisher` (
  ...
  CONSTRAINT `publisher_ibfk_1` FOREIGN KEY (`username`) REFERENCES `user` (`username`)
...
INSERT INTO `publisher` VALUES ('bhu1','p001','Udit Kumar','mohammad@gmail.com','Chandigarh');
